...
def render_filters(df):
    ...
    # Exclude Returns
    exclude_returns = st.sidebar.checkbox("Exclure les retours", value=False)
    ...
    # Apply filters
    if len(date_range) == 2:
        filtered_df = filter_data(df, country, date_range, min_order_value=min_order, exclude_returns=exclude_returns)
    else:
